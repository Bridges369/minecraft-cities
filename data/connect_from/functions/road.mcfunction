...
execute unless block ~ ~-1 ~16 emerald_block run clone 32 3 64 51 4 65 ~ ~ ~14 masked force
#> if NEXT == road
...
execute unless block ~ ~-1 ~-16 emerald_block run clone 32 3 64 51 4 65 ~ ~ ~ masked force
#> if NEXT == road
